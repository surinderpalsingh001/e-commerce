    ...
    <body>
        <div class="container">
            <div class="col col-lg-10 offset-2 mt-lg-5">
                <h1>Product Varients Table</h1>
                <table class="table table-success table-striped">
                    <thead>
                        <tr>
                        <th>Varient Attribute ID</th>
                        <th>Varient Name</th>
                        <th>Varient Key</th>
                        <th>Varient Value</th>
                    ...
                    <?php
                    $query = "SELECT * FROM varientattributes ORDER BY id DESC LIMIT {$offset},{$limit}";
                    ...
                    if($result)
                    {
                        ...
                        <tbody>
                            ...
                            <td><?php echo $data['last_varient_id']; ?></td>
                            <td><?php echo $data['attribute_key']; ?></td>
                            <td><?php echo $data['attribute_value']; ?></td>
                            <td>
